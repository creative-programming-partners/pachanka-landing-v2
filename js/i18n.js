...
(function () {
  const EN = {
    ...
    'alt.plate2': 'Guest with a dish from the Pachanka menu',
    ...
    'alt.sketch2': 'Ink illustration of a ceviche from the Pachanka menu',
    'alt.plate': 'Long table sharing dishes from the Pachanka menu',
